...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-green-088-maximal-covering-interval-986588fb-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GREEN-088"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-green-088-maximal-covering-interval-986588fb-v1",
      "problem_contract_sha256": "80741b194bb633680efdcd5ddbc124300a125a6a8548a04ac3338f2b96cebe84",
      "problem_id": "problem:um-green-088-maximal-covering-interval-986588fb",
      "route_id": "route:um-green-088-maximal-covering-interval-986588fb-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-green-088-maximal-covering-interval-986588fb-source-fidelity-01",
      "graph_id": "graph:um-green-088-maximal-covering-interval-986588fb-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-green-088-maximal-covering-interval-986588fb-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-green-088-maximal-covering-interval-986588fb-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "What is the largest $y$ for which one may cover the interval $[y]$ by residue classes $a_p \\pmod p$, one for each prime $p \\leq x$?"
          },
          "statement_sha256": "ec58d44f4a57d8fd8ec4caad1b27350c00cc7e970980368bb3c4f8167783d4a1"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-green-088-maximal-covering-interval-986588fb-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-green-088-maximal-covering-interval-986588fb-root",
      "route_id": "route:um-green-088-maximal-covering-interval-986588fb-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-green-088-b695500577b9",
        "url": "https://www.unsolvedmath.com/problems/GREEN-088"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
